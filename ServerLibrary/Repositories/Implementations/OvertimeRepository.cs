...
namespace ServerLibrary.Repositories.Implementations
{
    public class OvertimeRepository(AppDbContext appDbContext) : IGenericRepositoryInterface<Overtime>
    {
        ...
        {
            var item = await appDbContext.Overtimes.FirstOrDefaultAsync(eid => eid.ConsultantId == id);
        ...
        public async Task<Overtime> GetById(int id) =>
           await appDbContext.Overtimes.FirstOrDefaultAsync(eid => eid.ConsultantId == id);
