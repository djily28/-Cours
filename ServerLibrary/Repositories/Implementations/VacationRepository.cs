...
namespace ServerLibrary.Repositories.Implementations
{
    public class VacationRepository(AppDbContext appDbContext) : IGenericRepositoryInterface<Vacation>
    {
        ...
        {
            var item = await appDbContext.Vacations.FirstOrDefaultAsync(eid => eid.ConsultantId == id);
        ...
        public async Task<Vacation> GetById(int id) =>
            await appDbContext.Vacations.FirstOrDefaultAsync(eid => eid.ConsultantId == id);
